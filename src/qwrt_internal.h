 ...
 * C = const array in .rodata (default), A = zlib-compressed array → heap
 * decompress at load, B = external .polyfill file read at load,
 * D = host-provided via qwrt_polyfill_load_custom(). */
#define QWRT_POLYFILL_MODE_C 0
#define QWRT_POLYFILL_MODE_A 1
#define QWRT_POLYFILL_MODE_B 2
#define QWRT_POLYFILL_MODE_D 3
#ifndef QWRT_POLYFILL_MODE
#define QWRT_POLYFILL_MODE QWRT_POLYFILL_MODE_C
#endif
...
/* Mode A: zlib-compressed array in .rodata; decompressed to heap at load */
