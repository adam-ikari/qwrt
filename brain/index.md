...
_Auto-generated. Last updated 2026-08-28T15:53:31.373Z._
...
- [fetch-proxy-support](pages/fetch-proxy-support.md) — category: decision | tags: [fetch, proxy, connect, tls, uv_io] | - **背景**：B2「fetch 完善」剩余项「代理」—— 出站 fetch 需要能走环境 HTTP 代理；C 层 `uv_io.c` 实现 HTTP_PROXY/HTTPS_PROXY/NO_PROXY 环境变量，http 绝对式请求行 + https CONNECT 隧道（TLS 端到端），fail closed 不静默直连。
