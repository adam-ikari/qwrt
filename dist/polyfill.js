...
// src/lazy.js
  ...
  function installLazyProp(obj, prop, ensure) {
  ...
  function setupServiceWorker(pal2) {
    var self = globalThis;
    ...
    function handleControl(sw, registration, d) {
      ...
      if (d.phase === "install_done") {
        if (failed) {
          failSW(sw, registration, new Error("install failed: " + d.error));
          return;
        }
        ...
        if (failed) {
          failSW(sw, registration, new Error("activate failed: " + d.error));
          return;
        }
    ...
    container.register = function(url, options) {
      ...
      try {
        worker.postMessage({ __qwrt_sw__: "enter", url, scope });
    ...
    Worker.prototype.dispatchEvent = function(event) {
      ...
      for (var i = 0; i < handlers.length; i++) {
        ...
        try {
          ...
          var cb = typeof target === "function" ? target : target && typeof target.handleEvent === "function" ? target.handleEvent : void 0;
  ...
  var ensureM = lazyUnit(
    [
      ...
      "MessagePort",
      "MessageEvent",
      "__qwrt_lookup_port__",
      "__qwrt_deliver_port_msg__",
      "__qwrt_port_from_ref__"
    ],
    [],
    function() {
  ...
  var ensureCS = lazyUnit(
    ...
    function() {
      ...
      if (typeof pal.nativeDigest === "function" && typeof pal.__installCryptoSubtle__ === "function") {
        pal.__installCryptoSubtle__();
      } else if (!("subtle" in globalThis.crypto)) {
        globalThis.crypto.subtle = void 0;
      }
    }
  );
  lazyUnit(
