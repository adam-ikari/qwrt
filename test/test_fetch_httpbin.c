/*
 * Quick fetch test against httpbin.org (known-good TLS endpoint)
 */
...
int main(void)
{
    ...
    const char *code =
        ...
        "console.log('Fetching https://httpbin.org/get...');\n"
    ...
    if (rc != 0) { fprintf(stderr, "eval failed\n"); qwrt_destroy(rt); pal_uv_destroy(pal); return 1; }
