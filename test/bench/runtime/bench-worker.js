/* qzjs runtime-perf harness — worker subsystem metrics (R2/R2b/R3/R4/R5).
 *
 ...
 * are built from env QZ_BENCH_DIR (set by the driver, default
 * 'test/bench/runtime') so the harness is cwd-independent.
 *
 * Usage:  qzjs test/bench/runtime/bench-worker.js <mode> [params...]
 ...
 * for R3/R4).
 *
 * NOTE on slot reuse: QZ_MAX_WORKERS=16. The THREAD backend never releases
 * a worker slot until runtime teardown (qz_worker_terminate is fire-and-
 ...
 */
var BENCH_DIR = (globalThis.env && globalThis.env.QZ_BENCH_DIR) || 'test/bench/runtime';
