/**
 * Agent Scenario Benchmark — Simulates real AI agent workload
 *
 * Tests the JS-side overhead of an agent execution cycle,
 * excluding network I/O (LLM calls, MCP, fetch) which is identical
 * regardless of runtime.
 *
 * Run on Node.js: node bench_agent.js
 * Run on qwrt:    via test_benchmark.c agent section
 */
...
// Tool definitions (typical agent has 5-20 tools)
const TOOLS = [
...
// ============================================================================
// 1. Message Construction — Building conversation history
// ============================================================================
...
// ============================================================================
// 2. Tool Call Parsing — Parse LLM response, match tool, execute
// ============================================================================
...
// ============================================================================
// 3. Context Window Management — Trimming old messages
// ============================================================================
...
// ============================================================================
// 4. Memory Operations — Save/recall with metadata
// ============================================================================
...
// ============================================================================
// 5. Full Agent Loop — One complete turn (no I/O)
// ============================================================================
...
results.push(bench('agent.full_turn_no_io', () => {
    ...
    // 3. Simulate LLM response parsing
    ...
    // 4. Execute tool (simulated result)
...
// ============================================================================
// 6. Streaming SSE Parsing — Parse LLM streaming response chunks
// ============================================================================

console.log('\n=== 6. Streaming SSE Parsing ===');

// Simulate SSE chunks from an LLM streaming response
...
// ============================================================================
// 7. MCP Protocol — JSON-RPC message construction and parsing
// ============================================================================
...
results.push(bench('agent.mcp_discover_tools', () => {
    // Simulate tools/list response with 20 tools
    const tools = [];
    for (let i = 0; i < 20; i++) {
        tools.push({
            name: `tool_${i}`,
